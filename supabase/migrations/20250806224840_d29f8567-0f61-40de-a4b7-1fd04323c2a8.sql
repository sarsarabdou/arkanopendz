-- Update products with new images and clean content (fixed)
UPDATE products SET 
...
UPDATE products SET 
  ...
  description_fr = 'Garde-corps et rampes en aluminium, sécurité et esthétique.',
